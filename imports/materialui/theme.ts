...
const getLightTheme = (props: {
    ...
    return {
        ...
        typography: {
            ...
            fontWeightBold: 700,
            h1: { ...appStyles.h1(fontScale), color: appStyles.textPrimary },
            h2: { ...appStyles.h2(fontScale), color: appStyles.textPrimary },
            h3: { ...appStyles.h3(fontScale), color: appStyles.textPrimary },
            ...
            MuiButton: {
                ...
                styleOverrides: {
                    ...
                    outlined: {
                        ...
                        borderColor: appStyles.textPrimary
                    },
                },
            },
...
const getDarkTheme = (props: {
    ...
    return {
        ...
        typography: {
            ...
            fontWeightMedium: 700,
            fontWeightBold: 700,
            h1: { ...appStyles.h1(fontScale), color: appStyles.textWhite },
            h2: { ...appStyles.h2(fontScale), color: appStyles.textWhite },
            h3: { ...appStyles.h3(fontScale), color: appStyles.textWhite },
            h4: { ...appStyles.h4(fontScale), color: appStyles.textWhite },
            h5: { ...appStyles.h5(fontScale), color: appStyles.textWhite },
            h6: { ...appStyles.h6(fontScale), color: appStyles.textWhite },
            button: appStyles.button(fontScale),
            subtitle1: { ...appStyles.subtitle1(fontScale), color: appStyles.textWhite },
            body1: { ...appStyles.body1(fontScale), color: appStyles.textWhite },
            subtitle2: appStyles.subtitle2(fontScale),
            body2: appStyles.body2(fontScale),
            caption: appStyles.caption(fontScale),
        },
        components: {
            ...getLightTheme(props).components,
            MuiButton: {
                defaultProps: {},
                styleOverrides: {
                    root: {
                    ...
                    outlined: {
                        color: appStyles.textWhite,
                        borderColor: appStyles.textWhite
                    },
                },
            },
        }
